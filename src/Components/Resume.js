    ...
    const education = this.props.data.education.map(function (education) {
      return (
        <div key={education.school}>
          ...
          {education.description.fifth ? <p className="desc"><span>&bull;</span> {education.description.fifth}</p> : null}
          {education.description.sixth ? <p className="desc"><span>&bull;</span> {education.description.sixth}</p> : null} 
          <br></br>
        </div>
      );
    });
    ...
    const work = this.props.data.work.map(function (work) {
      return (
        <div key={work.company}>
          ...
          <br></br>
          {work.description2.first2 ? <p className="desc">{work.description2.first2}</p> : null}
          {work.description2.second2 ? <p className="work-desc"><span>&bull;</span> {work.description2.second2}</p> : null}
          {work.description2.third2 ? <p className="work-desc"><span>&bull;</span> {work.description2.third2}</p> : null}
          {work.description2.fourth2 ? <p className="work-desc"><span>&bull;</span> {work.description2.fourth2}</p> : null}
          {work.description2.fifth2 ? <p className="work-desc"><span>&bull;</span> {work.description2.fifth2}</p> : null}
          {work.description2.sixth2 ? <p className="work-desc"><span>&bull;</span> {work.description2.sixth2}</p> : null}
          {work.description2.seventh2 ? <p className="work-desc"><span>&bull;</span> {work.description2.seventh2}</p> : null}
          <br></br>
        </div>
      );
    });
